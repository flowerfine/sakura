...
public class CatalogServiceImpl implements CatalogService {
    ...
    public CatalogServiceImpl(CatalogDatabaseMapper catalogDatabaseMapper, CatalogTableMapper catalogTableMapper, CatalogFunctionMapper catalogFunctionMapper) {
